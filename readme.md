...
+ [The Brandable Submodules API](./docs/api/api.md)
    ...
    + [Download PDF](./docs/api/downloadPdf.md)
        + [Download PDF Settings](./docs/api/downloadPdf.md#downloadPdf-settings)
        + [Download PDF Functions](./docs/api/downloadPdf.md#downloadPdf-functions)
